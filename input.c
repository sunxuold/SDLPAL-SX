...
static const int g_KeyMap[][2] = {
   ...
   { SDLK_LALT,      kKeyMenu }, //B SDLK_RETURN--start  SDLK_ESCAPE--select
   { SDLK_RALT,      kKeyMenu },
   { SDLK_KP_0,      kKeyMenu },
   { SDLK_RETURN,    kKeySearch },
   { SDLK_KP_ENTER,  kKeySearch },  
   { SDLK_LCTRL,     kKeySearch }, //A  SDLK_TAB-L  SDLK_BACKSPACE-R   SDLK_LSHIFT--X   SDLK_SPACE-Y
   ...
   { SDLK_KP_1,      kKeyEnd },
   { SDLK_r,         kKeyRepeat },
   { SDLK_LSHIFT,    kKeyRepeat },   
   { SDLK_a,         kKeyAuto },
   { SDLK_SPACE,     kKeyAuto },   
   { SDLK_d,         kKeyDefend },
   { SDLK_BACKSPACE, kKeyDefend },   
   { SDLK_e,         kKeyUseItem },
