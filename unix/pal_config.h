...
//sunxu
//# define PAL_PREFIX           PAL_va(PAL_MAX_GLOBAL_BUFFERS-1,"%s%s", SDL_getenv("HOME"),"/.sdlpal-sx")
# define PAL_PREFIX       "./"
# define PAL_SAVE_PREFIX  PAL_va(PAL_MAX_GLOBAL_BUFFERS-1,"%s%s", SDL_getenv("HOME"),"/.sdlpal-sx")
...
#  define PAL_VIDEO_INIT_FLAGS  (SDL_HWSURFACE |SDL_DOUBLEBUF)
...
# define PAL_PLATFORM         "GKD350H"
# define PAL_CREDIT           "SX-Port"
