...
--*/
{
   ...
   /*
   printf("gAudioDevice.iMusicVolume %d\n",gAudioDevice.iMusicVolume);
   printf("gAudioDevice.iSoundVolume %d\n",gAudioDevice.iSoundVolume);
   printf("gAudioDevice.fMusicEnabled %d\n",gAudioDevice.fMusicEnabled);
   printf("gAudioDevice.fSoundEnabled %d\n",gAudioDevice.fSoundEnabled);
   printf("gAudioDevice.fOpened %d\n",gAudioDevice.fOpened);
   printf("gAudioDevice.spec.size %d\n",gAudioDevice.spec.size);
   printf("spec.size %d\n",spec.size);
   */
